...
<script>
  ...
  //     dataPoints: [
  //       <?php
	// 		    foreach ($lineChartIncome as $chart) {
  //             echo '{ x: '.$chart->month.',y: '.$chart->monthlyTestPrice.' },';
	// 		    }
  ...
  var chart = new CanvasJS.Chart("chartContainerPie", {
    ...
    data: [{
      ...
      dataPoints: [
        ...
        { y: <?php echo $TotakIncome; ?>, label: "TotakIncome" },
        { y: <?php echo $TotalExpense; ?>, label: "TotalExpense" },
        { y: <?php echo $TotalDiscount; ?>, label: "TotalDiscount" },
